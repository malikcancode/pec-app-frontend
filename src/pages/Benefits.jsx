...
import { FaChartLine, FaUsers, FaStore, FaDollarSign } from "react-icons/fa";
...
export default function Benefits() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 text-white">
      {/* Hero Section */}
      <section className="text-center py-16 px-4 bg-gradient-to-r from-green-600 to-emerald-500">
        <h1 className="text-4xl md:text-5xl font-extrabold mb-4">
          Commission Benefits & Growth Structure
        </h1>
        <p className="text-gray-100 max-w-2xl mx-auto">
          Explore how you can earn more as your network grows. Every tier brings
          you closer to higher rewards and weekly benefits.
        </p>
      </section>
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            <h2 className="text-3xl font-bold text-green-600 mb-4 flex items-center gap-2">
              <FaUsers className="text-green-500" /> This Structure Incentivizes
              You To:
            </h2>
